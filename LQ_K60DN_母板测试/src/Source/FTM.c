...
//函数名: Servo_FTM_PWM_Init                                                        
//功  能: FTM的PWM功能 ,舵机PWM初始化                                                       
//参  数: ftmn:模块名FTM0,FTM1，FTM2
//        ch  :通道号 对应引脚参考ftm.h文件
//        mod :脉冲宽度  范围（0~65535）
//        cv  :高电平宽度 范围（0~mod）
//返  回: 无                                                              
//简  例: Servo_FTM_PWM_Init(FTM0,FTM_CH6,65535,32768); 这样占空比是50%                                 
//-------------------------------------------------------------------------*
void Servo_FTM_PWM_Init(FTMn_e ftmn, FTM_CHn_e ch, u16 mod, u16 cv)
{
