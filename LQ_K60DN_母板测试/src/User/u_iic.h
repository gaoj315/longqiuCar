...
#define SDA_PORT  PORTE    //SDA使用E端口     1.修改模拟IIC引脚时需要修改
#define SDA_INDEX 8       //SDA使用E8引脚
#define SCL_PORT  PORTE    //SCL使用E端口
#define SCL_INDEX 7       //SCL使用E7引脚
...
//IO操作函数	 
#define IIC_SCL    PTE7_OUT //SCL             2.修改模拟iic引脚时需要修改
